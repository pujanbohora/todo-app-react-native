...
export declare type TopBottomLeftRightStyle = {
...
export declare type TopBottomLeftRightClass = `${Valueof<typeof modes>}${typeof sides[number]}-${keyof typeof lengths}`;
export declare const buildTopBottomLeftRight: () => TopBottomLeftRightStyle;
export {};
